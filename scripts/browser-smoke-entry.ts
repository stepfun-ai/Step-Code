import { createAssistantMessageEventStream, Type } from "@step-harness/providers";
import { complete, getModel, getProviders, streamSimple } from "@step-harness/providers/compat";
import {
	Agent,
	bashExecutionToText,
	convertToLlm,
