...
For non-Windows cross-builds, or for custom Windows toolchains, set `STEP_TUI_WIN32_TOOLCHAIN=mingw` and provide MinGW-compatible compilers:

```sh
STEP_TUI_WIN32_TOOLCHAIN=mingw \
