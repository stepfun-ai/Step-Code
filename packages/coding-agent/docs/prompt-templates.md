> step can create prompt templates. Ask it to build one for your workflow.
...
Step loads prompt templates from:

- Global: `~/.stepcode/agent/prompts/*.md`
- Project: `.stepcode/prompts/*.md` (only after the project is trusted)
