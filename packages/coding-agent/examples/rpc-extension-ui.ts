...
import { resolveStepAgentDir } from "@step-harness/coding-agent";
...
async function main() {
	...
	const cliPath = join(__dirname, "../dist/bundle/step.js");
	...
	const tui: TUI = new TuiMainScreen(terminal, undefined, resolveStepAgentDir());
