...
declare module "@step-harness/pi-tui" {
...
export const KEYBINDINGS = {
	...TUI_KEYBINDINGS,
	"tui.input.newLine": {
		...TUI_KEYBINDINGS["tui.input.newLine"],
		defaultKeys: ["shift+enter", "alt+enter", "ctrl+j"],
	},
	"tui.editor.undo": {
	...
	"app.redraw": {
		defaultKeys: [],
		description: "Repaint the screen (recovers a garbled terminal)",
	},
	...
	"app.message.dequeue": {
		defaultKeys: ["up", windowsKeybindings ? "alt+q" : "alt+up"],
		description: "Restore queued messages",
	},
	"app.clipboard.pasteImage": {
		// ctrl+v on macOS/Linux; alt+v on Windows/WSL, where the terminal owns ctrl+v
		// as its own paste and the app never receives it as a keypress. macOS Cmd+V is
		// handled separately via the empty bracketed paste (see CustomEditor.onEmptyPaste).
