...
import type { AssistantMessage, ToolResultMessage, Usage } from "@step-harness/providers";
import { Container, Text, type TUI } from "@step-harness/pi-tui";
...
import type { ToolExecutionComponent } from "../../../src/ui/view/transcript/tool-execution.ts";
...
type RenderSessionContextThis = {
	...
	ui: TUI;
	redraw: { requestRender(): void; forceRender(): void; renderNow(): void };
	settingsManager: {
