import type { Component, Terminal, TUI } from "@step-harness/pi-tui";
import { Container, isViewportTUI, Text } from "@step-harness/pi-tui";
import { beforeEach, describe, expect, it, vi } from "vitest";
import { VirtualTerminal } from "../../../packages/tui/test/virtual-terminal.ts";
import type { FullscreenExitOutput, TuiMode } from "../../../packages/coding-agent/src/core/settings-manager.ts";
import {
	createInteractiveTui,
	createInteractiveTuiReference,
	InteractiveMode,
} from "../src/ui/interactive-mode.ts";
...
vi.mock("../../../packages/coding-agent/src/utils/clipboard.ts", () => clipboardMocks);
...
describe("InteractiveMode right-click paste", () => {
	it("feeds clipboard text to the focused component as a bracketed paste", async () => {
		...
		const context = {
			...
			ui: { requestRender },
			redraw: { requestRender, forceRender: vi.fn(), renderNow: vi.fn() },
		};
