...
import type { MarkdownTransformContext } from "../../../packages/coding-agent/src/core/extensions/types.ts";
import type { MermaidRenderingMode } from "../../../packages/coding-agent/src/core/settings-manager.ts";
import { createMermaidMarkdownTransformer } from "../src/ui/view/transcript/mermaid.ts";
import type { Theme } from "../../../packages/coding-agent/src/theme/theme.ts";
